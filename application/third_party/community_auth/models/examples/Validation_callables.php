...
class Validation_callables extends MY_Model {
	...
	public function _check_password_strength( $password )
	{
		...
		$error = '<li>Minimal ' . config_item('min_chars_for_password') . ' karakter</li>';

		if( config_item('max_chars_for_password') > 0 )
                    $error .= '<li>tidak lebih dari ' . config_item('max_chars_for_password') . ' karakter</li>';
		...
		if( config_item('min_digits_for_password') > 0 )
		{
                    ...
                    $error .= '<li>' . config_item('min_digits_for_password') . ' angka' . $plural . '</li>';
		}
		...
		if( config_item('min_lowercase_chars_for_password') > 0 )
		{
                    ...
                    $error .= '<li>' . config_item('min_lowercase_chars_for_password') . ' huruf kecil' . $plural . '</li>';
		}
		...
		if( config_item('min_uppercase_chars_for_password') > 0 )
		{
                    ...
                    $error .= '<li>' . config_item('min_uppercase_chars_for_password') . ' huruf besar' . $plural . '</li>';
		}
		...
		$this->form_validation->set_message(
                    ...
                    '<span class="redfield">Password</span> harus memiliki:
                        <ul>
                                ' . $error . '
                        </ul>
                    </span>'
