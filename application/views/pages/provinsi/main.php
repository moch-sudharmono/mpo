...
<div class="portlet">
    ...
    <div class="portlet-body">
        <div class="table-container">
            <?php $this->load->view('pages/provinsi/table') ?>
        </div>
    </div>
</div>
<!-- End: life time stats -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php $this->load->view('pages/provinsi/form') ?>
            </div>
...
<script>
    ...
    grid.init({
        ...
        dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options 
            ...
            "ajax": {
                "url": "<?= base_url() ?>Wilayah_provinsi/admin_ajax_list", // ajax source,
            },
            "order": [
                [1, "desc"]
            ],
    ...
    function get_csrf() {
        $.ajax({
            type: "get",
            url: "<?php echo base_url() ?>Wilayah_provinsi/get_csrf_json",
            data: "",
    ...
    $('#datatable tbody').on('click', '.detail', function () {
        ...
        $.ajax({
            type: "get",
            url: "<?= base_url() ?>Wilayah_provinsi/get_data_by_id_json",
            data: "id=" + id,
            success: function (response) {
                // get CSRF First
                get_csrf();
    ...
    $('#datatable tbody').on('click', '.delete', function () {
        ...
        if (confirm('Anda yakin menghapus data ini')) {
            $.ajax({
                type: "get",
                url: "<?= base_url() ?>Wilayah_provinsi/hapus_json",
                data: "id=" + id,
                success: function (response) {
                    var data = JSON.parse(response);
